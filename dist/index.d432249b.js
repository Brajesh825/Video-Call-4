var saveAs = saveAs || function(e) {
    ...
    var t = e.document, n = function() {
    ...
    }, s = "application/octet-stream", d = 40000, c = function(e) {
        var t = function() {
            if (typeof e === "string") n().revokeObjectURL(e);
            else e.remove();
        };
        setTimeout(t, d);
    }, l = function(e, t, n) {
        ...
        if (/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)) return new Blob([
    ...
    if (typeof navigator !== "undefined" && navigator.msSaveOrOpenBlob) return function(e, t, n) {
        t = t || e.name || "download";
        if (!n) e = p(e);
...
//# sourceMappingURL=index.d432249b.js.map
